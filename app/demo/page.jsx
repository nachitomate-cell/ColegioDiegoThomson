...
const STEPS = [
  {
    ...
    subtitle: 'Colegio Diego Thomson · Demo para Dirección · Abril 2026',
  ...
  },
  {
    ...
    accent: 'text-blue-400',
    credencialAdmin: { rut: '98.765.432-5', pass: 'Admin2026!' },
  },
  {
    id: 'apoderado',
    emoji: '🎒',
    title: 'Portal del Estudiante',
    subtitle: 'Acceso directo con RUT del estudiante',
    content: 'El estudiante (o su apoderado) ingresa con el RUT del alumno y ve todas sus cuotas, paga online con su tarjeta, o sube un comprobante de transferencia bancaria.',
    bullets: [
      '💳 Pago online instantáneo con Webpay Plus',
      '📸 Subir comprobante de transferencia',
      '📄 Descargar recibo PDF oficial de cada pago',
      '📱 100% funcional desde el celular',
    ],
    cta: 'Ver Portal del Estudiante →',
    ctaLink: '/dashboard',
    ctaNext: 'excel',
    bg: 'from-emerald-950 to-slate-900',
    accent: 'text-emerald-400',
    cuentas: [
      { label: 'Sofía González — Buen historial (8 pagadas)', rut: '20.123.456-5', pass: 'Demo2026!', tag: '✅ Al día' },
      { label: 'Diego Muñoz — Comprobante en revisión', rut: '21.234.567-9', pass: 'Demo2026!', tag: '🟡 En revisión' },
      { label: 'Valentina Herrera — 6 cuotas atrasadas', rut: '19.765.432-5', pass: 'Demo2026!', tag: '🔴 6 cuotas atrasadas' },
    ],
  },
  {
    id: 'excel',
